...
ff_tab_ft = flextable::width(ff_tab_ft,j=1,  width = 1.2)
ff_tab_ft = flextable::width(ff_tab_ft,j=2,  width = 1.5)
ff_tab_ft = flextable::width(ff_tab_ft,j=3,  width = 3.5)
ff_tab_ft
...
## Flow-ecology correlations and first pass predictor selection
...
## Linear model selection for coho only
...
<!-- SY_rows = grepl(pattern = "SY", x = rownames(corr_matrix_pearson_chinook)) -->
<!-- RY_FA = grepl(pattern = "RY_FA", x = rownames(corr_matrix_pearson_chinook)) -->
<!-- remove_rows = SY_rows + RY_FA -->

<!-- corr_matrix_pearson_chinook = corr_matrix_pearson_chinook[!SY_rows,] -->
...
For Chinook, no significant relationships were calculated between the three ecological observation types and the Brood Year reconnection dates (i.e., no R^2^ values exceeded 0.1).
...
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_spawner_abundance", num_xs = 1, ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_spawner_abundance", num_xs = 2, alpha_val=0.1)
# 
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_smolt_abun_est", num_xs = 1, ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_smolt_abun_est", num_xs = 2, alpha_val=0.1)
# 
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_smolt_per_fem", num_xs = 1, ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_smolt_per_fem", num_xs = 2, alpha_val=0.1)
# 
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_redds_in_brood", num_xs = 1, xlab_text = "linear model P value", ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "coho_redds_in_brood", num_xs = 2, alpha_val=0.1, xlab_text = "linear model P value")
# dev.off()
# 
# par(mfrow =c(3,2), mar = c(4,4,3,2))
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "chinook_spawner_abundance", num_xs = 1, ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "chinook_spawner_abundance", num_xs = 2, alpha_val = .1)
# 
# test = all_lms_tab_and_plot(data_tab = metrics_tab_co, y_name = "chinook_juvenile_abundance", num_xs = 1, ylab_text = "Adj. R squared")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_co, y_name = "chinook_juvenile_abundance", num_xs = 2,alpha_val = .1)
# 
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "chinook_juv_per_adult", num_xs = 1, ylab_text = "Adj. R squared", xlab_text = "linear model P value")
# test = all_lms_tab_and_plot(data_tab = metrics_tab_ch, y_name = "chinook_spawner_abundance", num_xs = 2, alpha_val = .1, xlab_text = "linear model P value")
...
Figure \@ref(fig:hbfBarchar) also highlights that three of the four selected hydrologic metrics are negatively correlated with coho spf values. This means the HB function relies on a positive intercept value to generate positive coho spf predictions, and because the intercept value can be outweighed by combinations of flow metric values that are within the range of possibility, this formulation allows the prediction of negative values. A negative value, or a prediction of coho smolt consumption rather than production, is obviously not possible based on our understanding of the coho salmon life cycle (Figure \@ref(fig:cohoLifeCycleFigure)).
