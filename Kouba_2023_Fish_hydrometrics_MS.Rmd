...
# 2. Case study: setting and species of concern
...
par(mfrow=c(2,3))
for(i in 1:dim(metrics_tab_all)[2]){
  plot(metrics_tab_all[,i], 
       metrics_tab_all$chinook_juv_per_adult, 
       pch = 19, col = i,
       main = colnames(metrics_tab_all)[i])
}
