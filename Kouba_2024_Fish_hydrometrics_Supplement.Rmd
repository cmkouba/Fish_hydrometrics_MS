...
```{r fig2Yarnell2020, fig.cap.pre = "S", fig.lp = "supp-fig", echo = F, message = F, warning =F, fig.height = 8.5, fig.cap = "Figure 2 from Yarnell et al., 2020. Illustration of five functional flow categories identified for a mixed rain-snowmelt runoff river in California."}
...
## LASSO results, juvenile abundance on hydro. and spawners
