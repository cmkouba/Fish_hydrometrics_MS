...
```{r pred_corr_screening_table, echo = F, warning =F, comment = F}
...
elim_pred_tab_col2 = c("How wet the wet season (year 1)",
                       "How wet the wet season (year 2)",
                       "How dry the dry season (pre-spawning)",
                       "Dry to wet transition timing (year 2, rearing juv.)",
                       "How long the wet season (year 1, as brooding eggs and fry)",
                       "Fall pulse magnitude (year 1, during spawning)",
...
ept_tab_ft = flextable::width(ept_tab_ft,j=1,  width = 4)
...
keepers = c(non_preds, as.character(unique(ctl$Var1)))
metrics_tab_screened = metrics_tab[,keepers]
...
metrics_tab_screened_chinook = 
  metrics_tab_screened[, metrics_before_chinook_outmigrate]
...
metrics_tab_long = metrics_tab_long[,keepers]
