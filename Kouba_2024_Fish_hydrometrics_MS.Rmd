...
Criteria used to evaluate model performance included degree of variability explained by the predictors ($R^2$ and adjusted $R^2$, where adjusted $R^2$ includes a penalty for small sample size or large number of predictors), statistical significance (p-value and F-statistic), and the amount of total non-correlated information contained in the set of predictors (corrected AIC, or AIC~c~, a statistic used for small sample sizes).
