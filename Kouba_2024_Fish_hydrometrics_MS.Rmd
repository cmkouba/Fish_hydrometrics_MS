...
greater_than_0.5_finder = apply(X= corr_matrix_pearson, MARGIN = 1,
                                function(x){sum(abs(x) >= 0.5) > 0})
pred_subset = row.names(corr_matrix_pearson)[greater_than_0.5_finder] # CURRENTLY HERE
