...
include_figs = T
replace_setting_fig = T# setting to F can save time if no need to re-render map
fig_i = 1
...
column_labels = c("Obs. ID","Abbrev.","Description", "Monitoring Details", "Source(s)", "Relevant Seasons")
