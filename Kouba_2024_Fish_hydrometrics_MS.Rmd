...
**I'm being picky here for sure but this makes it sound like these later spawners are creating less fit juveniles. This could be true in a sense but if its exogenous factors (e.g., the flow regime at the time these juveniles emerge) that are the culprit what is the more the causal factor (later spawning or poor rearing conditions)? This would require some more analysis to fully tease out I think**
