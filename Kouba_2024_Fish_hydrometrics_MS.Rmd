...
We used all hydrologic predictors to generate the set of all possible 1- and 2-predictor linear models of the relative reproduction for Chinook (Chinook jpa) and coho (coho spf) salmon. One-predictor models performed categorically worse than two-predictor models (Figure \@ref(fig:allLMsCohoChinook)). This is an expected outcome and likely reflects some overfitting in two-predictor models. Diagnostics for all linear models are included in *Supplemental Tables 3* through *6*.
...
best_demo = data.frame(model_id = c("lm2a","lm2b","lm2c"), x1=best_2$pred1, x2 = best_2$pred2)
...
best_predobs = rbind(best_1, best_2)
