...
author: "Claire Kouba, Jason Wiener and Thomas Harter"
date: "Nov. 2023"
output: 
...
In this watershed, flow thresholds at the Fort Jones gauge can be closely tied to physical access for spawning. Salmon passage to access the lower mainstem is possible at a Fort Jones flowrate (~20-40 cfs), while access to upper tributaries is generally associated with a Fort Jones flowrate of 100 cfs  [@Sommarstrom2020]. The fact that the lasso method identified multiple flow thresholds in the coho spf model may support this understanding, and suggest that the coho may experience these different degrees of river connectivity and/or flow conditions as events with different ecological consequences.
