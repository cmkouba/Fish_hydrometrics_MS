...
To select a final lambda value, we considered the percentage of deviation explained, the number of coefficients, and the test error of the 10,000 randomly sampled test and training sets.
...
for(i in 1:length(y_vals)){
  y_val = y_vals[i]
  top_preds = sort(abs(corr_tab_2[,y_val]), decreasing = T)[1:num_top_pred]
