...
Single-species forecasts are valuable! [@WardEtAlLeveraging2024] Simpler linear models are better than more complex models (details?) [@WardEtAlLeveraging2024]! Environmental variables (which ones?) can predict X % of variation in fish recruitment. [@WardEtAlLeveraging2024] 
