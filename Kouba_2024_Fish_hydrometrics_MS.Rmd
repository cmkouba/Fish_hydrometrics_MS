...
column_labels = c("Abbrev.","Description", "Monitoring Details","Relevant Seasons")
...
em_tab_ft = flextable::width(em_tab_ft,j=2,  width = 2.5)
em_tab_ft = flextable::width(em_tab_ft,j=3, width = 2.5)
em_tab_ft = flextable::width(em_tab_ft,j=4,  width = 1)
em_tab_ft
